The notebook cannot be previewed on GitHub because its large size and widget metadata exceed GitHub’s rendering limits, but it opens normally when downloaded.
